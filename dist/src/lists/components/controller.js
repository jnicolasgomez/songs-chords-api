...
function default_1(injectedStore) {
    ...
    function getLists() {
        return __awaiter(this, void 0, void 0, function* () {
            let lists = yield injectedStore.list(LISTS_TABLE);
            return lists;
        });
    }
    function listsByUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            let lists = yield injectedStore.query(LISTS_TABLE, {
                $or: [
    ...
    function listById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let lists = yield injectedStore.query(LISTS_TABLE, { id });
            return lists;
        });
    }
